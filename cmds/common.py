...
class common(Cog_Extension):
  ...
  @cog_ext.cog_slash(name="poll",description=lang['poll.description'],options=[create_option(name="topic",description=lang['poll.options.topic'],option_type=3,required=True),create_option(name="option1",description=lang['poll.options.option1'],option_type=3,required=True),create_option(name="emoji1",description=lang['poll.options.emoji1'],option_type=3,required=True),create_option(name="option2",description=lang['poll.options.option2'],option_type=3,required=True),create_option(name="emoji2",description=lang['poll.options.emoji2'],option_type=3,required=True)])
